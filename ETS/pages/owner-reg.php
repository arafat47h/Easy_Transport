        ...
        <div class="col-md-6">
          <div class="d-reg">
            ...
            <p>sing in to trusted using your details</p>
                  <form action="o-reg.php" method="post">
                    ...
                    <input type="email" name="email" name="email" id="" placeholder="Email"><br>
                    <input type="password" name="pass" placeholder="Password" class="form-contro"><br>
                    <button name="submit" name="submit" class="submit">Submit</button>

          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="./o_request.php">Request</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="#"> Support</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="./driver-hire.php">Driver hire</a>
                </li>
                
                <li class="nav-item">
                  <a class="nav-link" href="#"> Massage</a>
                </li>
       ...
       <div class="col-md-4">
        ...
        <div class="col-md-8">
         ...
         <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d233668.38704183287!2d90.27923688469745!3d23.78057325530601!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8b087026b81%3A0x8fa563bbdd5904c2!2sDhaka!5e0!3m2!1sen!2sbd!4v1630306526034!5m2!1sen!2sbd" width="800" height="380" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
          <br><br><br><a href="./unassigned-v.php" style="text-decoration: none; color: white;background: #307d79;padding: 7px; border-radius: 12px;">Unassigned Vehicles</a>
          <br><br><br><a href="./see-vehicle.php" style="text-decoration: none; color: white;background: #307d79;padding: 7px; border-radius: 12px;" >See all Vehicles</a> 
          <!-- <br><br><br><a href="./history.php">History</a>  -->
